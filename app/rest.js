...
app.post('/GetEquipos',GetEquipos)
app.post('/AutenticarUsuario',AutenticarUsuario)
app.post('/GetInstantaneosDeEquipo',GetInstantaneosDeEquipo)
app.post('/GetHistoricosDeEquipoPorSensor',GetHistoricosDeEquipoPorSensor)
app.post('/GetHistoricosPorFechas',GetHistoricosPorFechas)
app.post('/GetMaximosYMinimos',GetMaximosYMinimos)
app.post('/ReadEquipos',ReadEquipos)
app.post('/DeleteEquipos',DeleteEquipos)
app.post('/ReadSensores',ReadSensores)
app.post('/DeleteSensores',DeleteSensores)
app.post('/ReadDatos',ReadDatos)
app.post('/DeleteDatos',DeleteDatos)
app.post('/ReadAsociaciones',ReadAsociaciones)
app.post('/DeleteAsociaciones',DeleteAsociaciones)
app.post('/ReadGrupos', ReadGrupos)
app.post('/ReadHeatmap',ReadHeatmap)
app.get('/seriescontrol',PlotHeatmap)
...
function ReadEquipos(req,res) {
	...
	CRUD.readEquipos(idEquipo,orderBy)
	.then(equipos=> {
